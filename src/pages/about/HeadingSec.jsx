...
export default function HeadingSec() {
  ...
  return (
    <div className="relative flex w-full flex-col items-center justify-center pt-20 sm:pt-40">
      ...
      <div className="absolute bottom-[-69px] right-[55px] h-36 w-36 rounded-full bg-dennisBlue-100 sm:bottom-[-70px] sm:right-[150px] lg:bottom-[-77px] lg:right-[200px] lg:h-40 lg:w-40 xl:bottom-[-100px] xl:right-[350px] xl:h-52 xl:w-52 2xl:right-[415px]">
        <Lottie
