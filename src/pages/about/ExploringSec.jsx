  ...
  return (
    <div className="flex w-full justify-center pt-40 ">
      <div className="relative ml-6 flex h-[1600px] w-[1440px] overflow-hidden sm:ml-40">
        ...
        <div className="absolute right-2 top-[-300px] h-[750px] overflow-hidden sm:right-10 sm:h-[950px] sm:w-[340px] lg:right-10 lg:h-[1150px] lg:w-[540px] xl:right-10 xl:h-[1400px] xl:w-[790px] 2xl:right-[-10px] 2xl:h-[1650px] 2xl:w-[1040px]">
          <img
            data-scroll
