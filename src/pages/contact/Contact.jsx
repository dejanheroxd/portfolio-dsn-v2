          ...
          <div className="sm:flex sm:justify-center">
            <div className="w-[350px] pb-28 sm:w-[500px] md:w-[550px] lg:w-[600px] xl:w-[650px] 2xl:w-[1000px]">
              ...
              >
                ...
                <div className="relative flex w-[315px] flex-col border-b border-neutral-600 py-8 md:w-[400px]  lg:w-[500px] xl:w-[450px] xl:py-14 2xl:w-[850px]">
                  ...
                  />
                  <button
                    className="absolute bottom-[-72px] right-4 h-36 w-36 rounded-full bg-dennisBlue-100 text-white xl:bottom-[-104px]  xl:h-52 xl:w-52"
                    type="submit"
                    disabled={state.submitting}
                  >
                    <p className="xl:text-[18px]">Send it!</p>
                  </button>
                </div>
              </form>
            </div>
            <div className="flex flex-col justify-center gap-y-6 pl-5 xl:h-[730px] xl:gap-y-10">
              ...
              <div className="flex flex-col gap-y-2 text-white">
                ...
                <p className="xl:text-xl">Awwwards</p>
                <p className="xl:text-xl">Instagram</p>
                <p className="xl:text-xl">Twitter</p>
                <p className="xl:text-xl">LinkedIn</p>
              </div>
            </div>
          </div>
        </div>
